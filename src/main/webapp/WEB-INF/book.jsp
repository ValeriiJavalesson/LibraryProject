...
<body>
	...
	<div class="container main-content">
		<div class="bookCard container d-flex flex-column flex-md-row justify-content-center mt-5">
						...
						<tr>
							...
							<td>${book.language}<c:choose>
									<c:when test="${book.language == 'Russian'}">
										<img src='style/images/ru.png' class='' alt='lang_icon' height='15px'>
									</c:when>
									<c:when test="${book.language == 'Ukrainian'}">
										<img src='style/images/ua.png' class='' alt='lang_icon' height='15px'>
									</c:when>
